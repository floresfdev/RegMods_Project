...
The coefficient summary table can be found in appendix A3. In the model, `r coeffPrimary[1]` is the empirical MPG mean for cars with automatic transmission. For the case of manual transmission, the value of `r coeffPrimary[2]` is an additional increase to the mentioned MPG mean.
...
The full summary of coefficients can be found in appendix A5. 
